...
public class PostfixNotation
{
	...
	static int eval(int b , int a , char op) {
		switch(op) {
		case '+':
			return a + b;
		case '-':
	...
	private static void solve(FastScanner s1, PrintWriter out){
		...
		String seq[] = s1.nextLine().split(" ");
		ArrayDeque<Integer> stack = new ArrayDeque<>();
		for(String s : seq) {
			char ch = s.charAt(0);
			stack.push(Character.isDigit(ch) ? Character.getNumericValue(ch) : eval(stack.pop(), stack.pop(), ch));
		}
	...
	static String fileName = "postfix";
